...
export const Data = [
    {
      name: "rat",
      year: generateYears(1900, 100, 12),
      description: "year of the rat",
      page: <Rat />,
    },
    {
        name:"ox",
        year: generateYears(1901, 100, 12),
        description:"year of the ox",
        page: <Ox />,
    },
    {
        name: "tiger",
        year: generateYears(1902, 100, 12),
        description: "year of the tiger",
        page: <Tiger />,
    },
    {
        name: "rabbit",
        year: generateYears(1903, 100, 12),
        description: "year of the rabbit",
        page: <Rabbit />,
    },
    {
        name: "dragon",
        year: generateYears(1904, 100, 12),
        description: "year of the dragon",
        page: <Dragon />,
    },
    {
        name: "snake",
        year: generateYears(1905, 100, 12),
        description: "year of the snake",
        page: <Snake />,
    },
    {
        name: "horse",
        year: generateYears(1906, 100, 12),
        description: "year of the horse",
        page: <Horse />,
    },
    {
        name:"sheep",
        year: generateYears(1907, 100, 12),
        description: "year of the sheep",
        page: <Sheep />,
    },
    {
        name: "monkey",
        year: generateYears(1908, 100, 12),
        description: "year of the monkey",
        page: <Monkey />,
    },
    {
        name: "rooster",
        year: generateYears(1909, 100, 12),
        description: "year of the rooster",
        page: <Rooster />,
    },
    {
        name: "dog",
        year: generateYears(1910, 100, 12),
        description: "year of the dog",
        page: <Dog />,
    },
    {
        name: "pig",
        year: generateYears(1911, 100, 12),
