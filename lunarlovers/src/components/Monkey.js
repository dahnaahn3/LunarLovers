...
const Monkey = () => {
  return (
    <div className=' animate__animated animate__fadeIn animate__slow mt-5 py-5 border border-orange-400 mx-auto w-3/4 lg:w-1/2 xl:w-1/3 bg-orange-200 rounded-lg shadow-lg'>
